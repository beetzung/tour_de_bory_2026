...
- **Костры и лагерь:** три кандидата на точку лагеря и правила по вариантам — [route.md](route.md); **fallback** — зона **Zanocuj w lasie** (Lasy Państwowe), GPS в [Логистика](logistics.md) § 1; костёр только где разрешено и по сценарию выбранной точки
