...
2. [Маршрут лагеря (А/Б/В)](route.md) — варианты места лагеря, разведка Д1, велотрек Bydgoszcz → А → Б → В
3. [Участники](members.md) — сводка по участникам (формат питания, даты, палатки, транспорт)
4. [Логистика](logistics.md) — Bory Tucholskie, транспорт, вода, мусор, 112, клещи
5. [Личный чеклист](gear-personal.md) — личный чеклист + координация по палаткам
6. [Лагерное имущество](gear-camp.md) — лагерное имущество машиной (палатки — клич и координация, не онлайн-заказ)
...
10. [Общая касса](expenses.md) — факт общей кассы (PLN; инфраструктура лагеря **÷ 25 чел**)
11. [To-do (🚧 work in progress)](todo.md) — задачи 
12. [Шрёдингеры](schrodingers.md) — резерв «может быть» (Женя, Лера, Лёша), сценарии +2/+3 поверх базы
...
- **Костры и лагерь:** три кандидата на точку лагеря и правила по вариантам — [route.md](route.md); **fallback** — зона **Zanocuj w lasie** (Lasy Państwowe), GPS в [Логистика](logistics.md) § 0; костёр только где разрешено и по сценарию выбранной точки
