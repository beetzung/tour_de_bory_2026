...
Зарегистрировано **25 человек**..

> **Шрёдингеры (+3)** — Женя, Лера, Лёша — учтены отдельно в [Шрёдингеры](schrodingers.md) и в счётчик 25 **не входят**. Базовые цифры ниже считаем без них
...
| Д3 3 мая | 25 | **19** (завтрак) / **15** (ужин) | 17 / 13 | 1 | 1 |
