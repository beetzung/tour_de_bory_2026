...
4. [Меню](menu.md) — **только завтраки и ужины** общей кухни (пик **19** чел; **Д3 ужин — Д5** меньше — см. файл); обеды и перекусы — лично
...
7. [Список покупок](shopping-grocery.md) — закупка в Biedronka/Lidl/Carrefour, с учётом выходных
8. [Заказы онлайн](shopping-online.md) — заказы на Allegro/Amazon.pl/Decathlon.pl
9. [Общая касса](expenses.md) — факт общей кассы (PLN; инфраструктура лагеря **÷ 25 чел**)
10. [To-do](todo.md) — задачи T-14 → Д5 с привязкой к датам апреля–мая 2026
