...
| **Костёр** | Легальные костры (по данным разведки) | **Нельзя** | **Нельзя**  |
...
1. **Занятость:** свободно ли место под **палатки + большой тент-столовая + навес** ([gear-camp.md](gear-camp.md)).
2. **Соседи (А):** сколько групп, шум, дистанция.
3. **Подъезд и парковка:** машина с грузом, велосипеды, грязь после дождя.
4. **Рельеф и тень:** без ям/корней под спальни; ветер к воде.
5. **Вода:** видимый доступ к озеру/ручью.
6. **Связь:** сигнал.
7. **Риски:** видимость с дороги/с воды (**B**).
...
|---|---|
| Lubiewo | Магазин |
| **Wieża ciśnień** | Место отдыха |
| Byslawek | Кафешки |
| **Leśny Zakątek** — лесные домики и причал | Место отдыха |
| **Guderian Bridge** — исторический мост | Место отдыха |
| Pruszcz | Магазин |
...
| 23.8 | Palac | Исторический объект |
