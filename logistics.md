...
flowchart TB
    ...
    subgraph d3["Д3"]
        t2["Утром Elijahby + приезд Арсения + Женя/Лера + Лёша"]
    end
    subgraph d45["Д4–Д5"]
...
- **Elijahby** — **Д1–Д3** (утром **Д4** уезжает — см. [members.md](members.md)); основной груз заезда вместе с **Женей/Лерой**.
...
- **Арсений (`ar53n1`)** — **Д3–Д5** (приезд **Д3**); обратный груз **Д5**, дозакупки/канистры **Д4** по договорённости.

**Д1 заезд + Д5 выезд:** груз делят **Elijahby**, **Женя/Лера**, по мелочи **Лёша**; на **Д5** к ним **Арсений**. **Д4** добор припасов — велосипеды + попутно машина **Арсения** (с **Д3** в лагере); отдельного рейса «только машина в магазин» нет.
...
- **Итого:** ~400 км, 5–6 часов в пути (с остановками) на полный цикл туда-обратно для машины из Варшавы
- **Топливо:** ~35 л × 6,5 zł/л ≈ **230 zł на ходку** на одну машину. Несколько водителей и разные города выезда — **считать по факту**; ориентир для машины «Варшава ↔ лагерь» дважды + местные выезды: **~500–750 zł суммарно по группе** (не из общей кассы — на водителей / договорённости).
