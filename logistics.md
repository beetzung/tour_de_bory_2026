...
> **Развилка:** рассматриваются варианты **А / Б / В** и разведка Д1 — см. **[route.md](route.md)**. Ниже — **fallback вариант В** (если А и Б не подошли).
...
**Аренды нет.** Лагерь обслуживают **четыре частные машины** участников (см. [Лагерное имущество](gear-camp.md), [Ручные правки](hardcoded_diff.md)).
...
- **Elijahby** — **Д1–Д3** (**вечером Д3** уезжает — см. [Участники](members.md)); основной груз заезда вместе с **Женей/Лерой**.
- **Женя/Лера** — **Д1–Д5**, своя машина; буфер по объёму на весь цикл (см. [Шрёдингеры](schrodingers.md) — если не подтвердятся к T-7, ребалансируем груз).
- **Лёша** — **Д1–Д5**, маленькая машина: **не грузовик**, только один человек + мелочи.
- **Арсений (@ar53n1)** — **Д3–Д5** (приезд **Д3** на машине); обратный груз **Д5**, дозакупки/канистры **Д2 и Д4** по договорённости.
...
См. [Лагерное имущество](gear-camp.md) раздел «Чеклист погрузки машины». Правило: «тенты первыми вынимаются, последними грузятся на отъезд».
...
> **Сценарий шрёдингер** ([Шрёдингеры](schrodingers.md)) — поверх базы:
...
Онлайн заказываем **одну** канистру **30 л с краном**; остальное — **канистры и бутыли у участников** (опрос до Д1) + бутыли из магазина. См. [Заказы онлайн](shopping-online.md), [Лагерное имущество](gear-camp.md).
...
**Д4 (пн, 4 мая) — магазины открыты.** То же: канистры с лагеря на велах (или иначе по договорённости), плюс дозакупка еды и быта по [Список покупок](shopping-grocery.md).
...
Инструменты для клещей, лупа, хлоргексидин, маркер для отметки покраснений — **у медика (Злата)** в её аптечке; в общий [Заказы онлайн](shopping-online.md) не входят.
